...
public class Calculator extends JFrame implements ActionListener {
    ...
    void initComponents() {
        ...
        b5 = new JButton("5");b5.setFont(font2);b5.setBackground(Color.LIGHT_GRAY);panel2.add(b5);
        b6 = new JButton("6");b6.setFont(font2);b6.setBackground(Color.LIGHT_GRAY);panel2.add(b6);

        minus = new JButton("-");minus.setFont(font2);minus.setBackground(Color.LIGHT_GRAY);panel2.add(minus);
        b1 = new JButton("1");b1.setFont(font2);b1.setBackground(Color.LIGHT_GRAY);panel2.add(b1);
        b2 = new JButton("2");b2.setFont(font2);b2.setBackground(Color.LIGHT_GRAY);panel2.add(b2);
        b3 = new JButton("3");b3.setFont(font2);b3.setBackground(Color.LIGHT_GRAY);panel2.add(b3);
        ...
        equal = new JButton("=");equal.setFont(font2);equal.setBackground(Color.green);panel2.add(equal);
        clear = new JButton("AC");clear.setFont(font2);clear.setBackground(Color.red);panel2.add(clear);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == sin) {
            ...
            if (flag == 1) {
             ...
             String s = textField.getText();
            b = Math.sin(Double.parseDouble(s));
            ...
            textField.setText("You have Input First");
        }
    }
